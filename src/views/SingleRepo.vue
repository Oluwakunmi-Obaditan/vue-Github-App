...
arrow_back
    ...
    <div v-if="!isLoading" class="single-repo-info">
        <SingleRepoDescription :description="repo?.description" />
...
import SingleRepoDescription from '../components/SingleRepoDescription.vue'
...
onMounted(async () => {
  try {
    const res = await fetch(`https://api.github.com/repos/Oluwakunmi-Obaditan/${route.params.id}`)
